...
% All walls coordinates of all quarters (first, second, third and fourth ):
...
% The differences of the distances between the corner and the walls of each quarter and than uses it as cost of the weak constraints
% Minimize the distances between walls and corners of each quarter
